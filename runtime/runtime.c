...
struct LispValue *
lisp_subtract (struct LispValue *arg1, struct LispValue *arg2)
{
  struct LispValue *result
      = (struct LispValue *)malloc (sizeof (struct LispValue));
  if (!result)
...
struct LispValue *
lisp_multiply (struct LispValue *arg1, struct LispValue *arg2)
{
  struct LispValue *result
      = (struct LispValue *)malloc (sizeof (struct LispValue));
  if (!result)
...
struct LispValue *
lisp_divide (struct LispValue *arg1, struct LispValue *arg2)
{
  struct LispValue *result
      = (struct LispValue *)malloc (sizeof (struct LispValue));
  if (!result)
...
void
lisp_debug_print (struct LispValue *arg)
{
  switch (arg->type)
    {
    case LVAL_NUM:
